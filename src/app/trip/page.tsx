...
const MainMenu: React.FC = () => {
  ...
  const handleSubmit = async () => {
    let msg = `Plan a trip to ${location} from ${dateRange?.[0].format("DD MMMM YYYY")} to ${dateRange?.[1].format("DD MMMM YYYY")} as ${typeList[type - 1]} with interest in ${category[0]}.  Using structured HTML tag and styling (without head and body tag)`;
